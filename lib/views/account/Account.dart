...
class _AccountState extends State<Account> {
  ...
  MyBalanceResultItem myBalanceResultItem = MyBalanceResultItem(
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: SingleChildScrollView(
          child: Padding(
            padding:
                const EdgeInsets.only(left: 12, right: 12, bottom: 8, top: 14),
            child: Column(
              children: <Widget>[
                new Container(
                                      ...
                                      onTap: () {
                                        if (isVerified() == true) {
                                          if (is_withdraw == '1' ||
                                            ...
                                            // withdrawInstantBankDialoge(context);
                                          } else {
                  ...
                  child: new Container(
                    child: new Card(
                      ...
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10.0),
                          side:
                              BorderSide(color: Color(0xffEDE2FE), width: 0.7)),
                      child: new Container(
                        padding: EdgeInsets.all(5),
                        child: new Container(
                          height: 50,
  ...
  void getUserBalance() async {
    ...
    if (myBalanceResponse.status == 1) {
      ...
      // AppPrefrence.putInt(
      //     AppConstants.SHARED_PREFERENCE_USER_AADHAR_VERIFY_STATUS,
      //     myBalanceResultItem.aadhar_verify);
      AppPrefrence.putInt(
      ...
      //     myBalanceResultItem.email_verify);
    }
    AppPrefrence.getInt(AppConstants.IS_ADDRESS_VERIFIED, 0).then((value) => {
          setState(() {
            Address_verify = value;
  ...
  void getUserLevel() async {
    AppLoaderProgress.showLoader(context);
    GeneralRequest levelRequest =
        new GeneralRequest(user_id: userId, fcmToken: '');
    final client = ApiClient(AppRepository.dio);
    LevelDataResponse levelDataResponse = await client.userLevel(levelRequest);
    // print(["levelDataResponse",levelDataResponse]);
    if (levelDataResponse.status == 1) {
      data = levelDataResponse.result;
    }
    AppLoaderProgress.hideLoader(context);
    setState(() {});
  }
  ...
  transferWinningCommission(BuildContext context) {
    winningAmountController.clear();
    return showDialog(
        context: context,
        builder: (context) {
          return Dialog(
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            '*Transfer Winning amount into Deposit with additional 6% cash offer',
                            style: TextStyle(
                                fontFamily: "Roboto",
                                color: Colors.black,
                                fontSize: 12,
                          ...
                          Container(
                            height: 45,
                            child: TextField(
                              controller: winningAmountController,
                              keyboardType: TextInputType.number,
                              decoration: InputDecoration(
                                counterText: "",
                                fillColor: Colors.white,
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    if (winningAmountController
                                        .text.isNotEmpty) {
                                      if (double.parse(
                                              winningAmountController.text) <
                                          100) {
                                        Fluttertoast.showToast(
                                            msg: "Minimum amount 100 ",
                                            toastLength: Toast.LENGTH_SHORT,
                                            timeInSecForIosWeb: 1);
                                        ...
                                        Fluttertoast.showToast(
                                            msg:
                                                "You can enter maximum amount 40000 ",
                                            toastLength: Toast.LENGTH_SHORT,
                                            timeInSecForIosWeb: 1);
                                      } else {
                                        Navigator.pop(context);
                                        showDialog(
                                          context: context,
                                          builder: (BuildContext context) {
                                            return transferWinningTopUpUI(
                                                context); // Your custom dialog widget
                                          },
                                        );
                                      }
                                    } else {
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Text(
                                      "On Transferring Cash from Winning to Deposit, you will get 6% Additional Real Cash from fantasy",
                                      style: TextStyle(
                                          fontFamily: "Roboto",
                                          fontSize: 12,
                                          color: Colors.black,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Text(
                                      "Min Limit - Rs. 100, Max Limit - Rs 40,000",
                                      style: TextStyle(
                                          fontFamily: "Roboto",
                                          fontSize: 12,
                                          color: Colors.black,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Text(
                                      "You can transfer only one time in a day",
                                      style: TextStyle(
                                          fontFamily: "Roboto",
                                          fontSize: 12,
                                          color: Colors.black,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Text(
                                      "Per month Cash Limit is Rs. 1,00,000",
                                      style: TextStyle(
                                          fontFamily: "Roboto",
                                          fontSize: 12,
                                          color: Colors.black,
  ...
  transferWinningTopUpUI(BuildContext context) {
    double winningPercentAmount = double.parse(winningAmountController.text) *
        double.parse(winningPercent) /
        100;
    double winningAmountPercentAmount =
        winningPercentAmount + double.parse(winningAmountController.text);
    return Dialog(
      shape: RoundedRectangleBorder(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '*($winningPercent% real cash will credited to Wallet by fantasy)',
              style: TextStyle(
